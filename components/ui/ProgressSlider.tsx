...
export const ProgressSlider = ({
    ...
    return (
        <View className={className}>
            ...
            <View className="flex-row items-center gap-3">
                ...
                <View className="flex-1">
                    <TextInput
                        ...
                        editable={!disabled}
                        className="h-12 rounded-lg px-4 text-center text-lg font-semibold"
                        style={{
            ...
            <Text className="mt-2 text-center text-xs" style={{color: colors.onSurfaceVariant}}>
    ...
    return (
        <View
            ...
            <View className="mb-2 flex-row items-baseline gap-1">
                ...
                <Text className="ml-auto text-sm font-semibold" style={{color: colors.primary}}>
                    {Math.round(progress)}%
                </Text>
            </View>
